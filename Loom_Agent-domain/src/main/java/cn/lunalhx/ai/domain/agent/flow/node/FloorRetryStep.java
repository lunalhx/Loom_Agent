 ...
 */
final class FloorRetryStep implements ContextOverflowStep {

    private static final java.util.Set<ContextOverflowStage> ACCEPTABLE_STATES =
            java.util.Set.of(ContextOverflowStage.NONE, ContextOverflowStage.FALLBACK_MODEL_SELECTED);
