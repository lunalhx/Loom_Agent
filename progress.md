...
- 2026-08-12: Completed semantic Plan Shell evidence for conservative `cat`, `ls`, `rg`, and Git forms; unsupported commands retain the safe whole-repository fallback. Root authorization now compiles the user policy and Maven grant from one immutable read.
