...
public class GitOpTool extends FileSystemToolSupport implements AgentTool {
    ...
    public ToolSpec spec() {
        return ToolSpec.builder()
                ...
                .inputSchema("{\"type\":\"object\",\"properties\":{\"operation\":{\"type\":\"string\",\"enum\":[\"status\",\"diff\",\"log\",\"init\",\"add\",\"commit\",\"push\",\"reset\",\"clean\",\"rebase\",\"checkout\"]}},\"required\":[\"operation\"],\"additionalProperties\":false,\"oneOf\":[{\"properties\":{\"operation\":{\"const\":\"status\"}}},{\"properties\":{\"operation\":{\"const\":\"diff\"},\"path\":{\"type\":\"string\",\"description\":\"可选相对路径\"}}},{\"properties\":{\"operation\":{\"const\":\"log\"},\"limit\":{\"type\":\"integer\",\"minimum\":1,\"maximum\":50,\"default\":10}}},{\"properties\":{\"operation\":{\"const\":\"init\"}}},{\"properties\":{\"operation\":{\"const\":\"add\"},\"path\":{\"type\":\"string\",\"description\":\"可选相对路径\"}}},{\"properties\":{\"operation\":{\"const\":\"commit\"},\"message\":{\"type\":\"string\",\"minLength\":1}}},{\"properties\":{\"operation\":{\"const\":\"push\"},\"remote\":{\"type\":\"string\",\"description\":\"可选 remote\"},\"refspec\":{\"type\":\"string\",\"description\":\"可选 refspec\"},\"force\":{\"type\":\"boolean\",\"default\":false}}},{\"properties\":{\"operation\":{\"const\":\"reset\"},\"branch\":{\"type\":\"string\",\"description\":\"可选分支\"},\"force\":{\"type\":\"boolean\",\"default\":false}}},{\"properties\":{\"operation\":{\"const\":\"clean\"},\"dryRun\":{\"type\":\"boolean\",\"default\":true}}},{\"properties\":{\"operation\":{\"const\":\"rebase\"},\"branch\":{\"type\":\"string\",\"description\":\"可选分支\"}}},{\"properties\":{\"operation\":{\"const\":\"checkout\"},\"branch\":{\"type\":\"string\",\"description\":\"可选分支\"},\"path\":{\"type\":\"string\",\"description\":\"可选相对路径\"}}}]}")
                .build();
    }
